    ...
    return (
        ...
        product ? (
            <>
                ...
                <Header />
                <div className='h-10 flex items-center justify-center border-b-2 border-black font-roboto'>
                    Welcome to the Shop!!
                </div>
                ...
                <div className=' flex flex-col md:flex-row '>
                    ...
                    <div className='h-[90vh] md:h-[90vh] md:w-[50%] bg-secondground flex flex-col md:border-l-2 md:border-black'>
