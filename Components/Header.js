...
const Header = () => {
  ...
  const sideBar = () => {
    ...
    return displaySideBar ? (
      <div className='h-screen w-3/4 fixed top-0 bg-slate-500 flex flex-col items-center justify-center text-xl z-50'>
      ...
      <header className='h-[75px] md:h-[95px]'>
        ...
        <div className='h-full bg-slate-500 flex flex-row md:h-3/5'>
          ...
          <div className="basis-1/2 bg-purple-40 md:hidden flex items-center">
            <div className='ml-5 w-14 h-14 flex items-center justify-center'>
          ...
          <div className="basis-1/2 bg-green-200 md:basis-1/4 flex justify-end md:justify-center items-center">
            ...
            <div className="relative z-10 mr-7 md:mr-5 w-14 h-14 mt-2 flex items-center justify-center">
              ...
              <div className='rounded-full bg-pink-600 w-5 h-5 absolute top-0 -right-1 flex items-center justify-center text-xs'>
                {numOfFav}
              </div>
            </div>

            {/* cart  */}
            <div className='relative z-10 w-14 h-14 mt-2 flex items-center justify-center mr-5'>
              <Link href={'/cart'}>
